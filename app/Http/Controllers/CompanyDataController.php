...
class CompanyDataController extends Controller
{
    ...
    public function companiesLocations()
    {
        ...
        $companies = DB::table('company_datas')
            ->select('company_datas.id', 'company_datas.logo', 'company_datas.longitude', 'company_datas.latitude', 'facility_owners.name_corporation', 'facility_owners.name_corporation_ar', DB::raw('ROUND(company_rates.rate_total) as rounded_rate'))
            ->join('facility_owners', 'company_datas.id_facility_owner', '=', 'facility_owners.id')
