...
//
    ...
    public function my_reservations(){
        try {
            ...
            ->join('reservation_statuses AS reservationStatus', 'reservationStatus.id', '=', 'childProg.id_reservation_statuses')
            ->join('company_datas AS company', 'company.id_facility_owner', '=', 'facility.id')
            ->leftJoin('program_discounts', 'program_discounts.id_program', '=', 'childProg.id_program')

            ->leftjoin('rate_father_companies', 'rate_father_companies.id_company', '=', 'company.id' ,'AND', 'rate_father_companies.id_father', '=', 'fatheChild.id')
            ->select('childProg.id AS childProg_id','childProg.created_at',
                    'company.id AS company_id', 'company.latitude', 'company.longitude',
                    'fatheChild.name AS child_name','fatheChild.id AS child_id',
                    'program.name_ar AS program_name_ar', 'program.name_en AS program_name_en', 'program.price_main AS program_price', 'program.description_en AS program_description_en', 'program.description_ar AS program_description_ar',
                    'facility.name_corporation AS name_company','facility.name_corporation_ar AS name_company_ar',
                    'reservationStatus.status_ar AS reservationStatus_status_ar', 'reservationStatus.status_en AS reservationStatus_status_en', 'reservationStatus.id AS reservationStatus_id' ,
                    'program_discounts.price_rate_discount As discount',
                    'rate_father_companies.id AS rate_father_companiesid'
                    )
