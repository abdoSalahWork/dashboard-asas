...
class NotificationController extends Controller
{
    ...
    public function sendNotification($title, $body, $device_token, $type_notification){
        $SERVER_API_KEY = 'AAAASG3qqzk:APA91bEXfBwjnfT4wgcEteBvRt5pfS-zxevfLFCbPWBx8HXeoVRlpfVymQeY_9ktxaLCXPtquweBrhaomIaidpE_cbcR7SZwbVdbQN5y5hGE_AAusGSNv5uvddL7zLB1tHbJlz2wtGgO';
