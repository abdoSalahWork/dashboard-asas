    ...
    <div class="card card-custom">
        <div class="card-header">
         <div class="card-title">
          <h3 class="card-label">تعديل اتفاقية جديدة</h3>
         </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12">
                            <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                ...
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid @error('name_ar') is-invalid @enderror"  value="{{ $agreement->name_ar}}" placeholder="اسم الاتفاقية" name="name_ar" required>
                            ...
                            <div class="form-group">
                                ...
                                <span class="required"></span>
                                <textarea  name = "short_description_ar" class="form-control form-control-solid @error('short_description_ar') is-invalid @enderror" rows="3" required>{{$agreement->short_description_ar}}</textarea>
                        ...
                        <div class="col-lg-6 col-sm-12">
                            ...
                            <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                <!--begin::Label-->
                                <label class="d-flex align-items-center fs-6 fw-bold mb-2">اسم الاتفاقية انجليزي
                                    <span class="required"></span>
                                    {{-- <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="" data-bs-original-title="Specify a target name for future usage and reference" aria-label="Specify a target name for future usage and reference"></i> --}}
                                </label>
                                <!--end::Label-->
                                <input type="text" class="form-control form-control-solid @error('name_en') is-invalid @enderror"  value="{{$agreement->name_en}}" placeholder="اسم الاتفاقية" name="name_en" required>
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            ...
                            <div class="form-group">
                                ...
                                <span class="required"></span>
                                <textarea  name = "short_description_en" class="form-control form-control-solid @error('short_description_en') is-invalid @enderror" rows="3" required>{{ $agreement->short_description_en}}</textarea>
