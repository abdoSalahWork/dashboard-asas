                            ...
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('login') }}">
                                        <input type="button" class="btn btn-primary" value="المشرف">
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="{{ URL('/login_page/facility') }}">
                                        <input class="btn btn-primary" type="button" value="صاحب مؤسسة ">
                                    </a>
                                </li>
                            @endif
