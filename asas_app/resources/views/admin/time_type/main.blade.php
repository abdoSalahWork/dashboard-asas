...
<div class="container">
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-body">
         ...
         <form action="{{url('/admin/timeTypes')}}" method="post">
            @csrf
            <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                <!--begin::Label-->
                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                    <span class="required">نوع الدوام انجليزي</span>
                ...
                <!--end::Label-->
                <input type="text" class="form-control form-control-solid @error('time_type_en') is-invalid @enderror"  value="{{ old('time_type_en') }}" placeholder="ادخل نوع الدوام" name="time_type_en">
                <div class="fv-plugins-message-container invalid-feedback"></div>
                @if ($errors->has('time_type_en'))
                      <span class="text-danger">{{ $errors->first('time_type_en') }}</span>
                  @endif
            </div>
            ...
            <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                <!--begin::Label-->
                <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                    <span class="required">نوع الدوام عربي</span>
                    {{-- <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="" data-bs-original-title="Specify a target name for future usage and reference" aria-label="Specify a target name for future usage and reference"></i> --}}
                </label>
                <!--end::Label-->
                <input type="text" class="form-control form-control-solid @error('time_type_ar') is-invalid @enderror" value="{{ old('time_type_ar') }}" placeholder="ادخل نوع الدوام" name="time_type_ar">
                <div class="fv-plugins-message-container invalid-feedback"></div>
                @if ($errors->has('time_type_ar'))
                      <span class="text-danger">{{ $errors->first('time_type_ar') }}</span>
                  @endif
            </div>
        ...
        <div class="card-body">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>نوع الدوام انجليزي</th>
                        <th>نوع الدوام عربي</th>
                        <th>الحالة</th>
                        <th></th>
                        <th></th>
                ...
                <tbody>
                    <?php $counter = 1;?>
                    @foreach ($time_types as $item)
                        <tr>
                            <td>{{$counter++}}</td>
                            <td>{{$item->time_type_en}}</td>
                        ...
                        <div class="modal fade" id="exampleModalScrollable{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{URL('/admin/timeTypes',$item->id)}}" method="post">
                                        @csrf
                                        @method('PUT')
                                        <div class="modal-body" style="height: 300px;">
                                            <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Label-->
                                                <input type="text" class="form-control form-control-solid @error('time_type_en') is-invalid @enderror"  value="{{$item->time_type_en}}" placeholder="ادخل نوع الدوام" name="time_type_en">
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                                @if ($errors->has('time_type_en'))
                                                      <span class="text-danger">{{ $errors->first('time_type_en') }}</span>
                                                  @endif
                                            ...
                                            <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Label-->
                                                <input type="text" class="form-control form-control-solid @error('time_type_ar') is-invalid @enderror" value="{{$item->time_type_ar}}" placeholder="ادخل نوع الدوام" name="time_type_ar">
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                                @if ($errors->has('time_type_ar'))
                                                      <span class="text-danger">{{ $errors->first('time_type_ar') }}</span>
                                                  @endif
